...
import { 
  ...
  UserCheck,
  Video,
  LucideBrickWallShield as Tennis,
  Eye,
  Cloud,
  Sunrise,
  Box,
...
interface SquashCourt {
  ...
  courtType: "Glass Back" | "Traditional" | "Championship";
  courtCount: number;
  courtMaterial: "Timber" | "Plastic" | "Concrete" | "Multipurpose";
  airConditioned: boolean;
  equipmentRental: boolean;
  professionalCoach: boolean;
  courtCondition: "Excellent" | "Good" | "Fair";
  changingRooms: boolean;
  scoreboard: boolean;
  ballMachine?: boolean;
  parking: boolean;
  ventilation: "Excellent" | "Good" | "Fair";
  lighting: "Professional" | "Standard" | "Basic";
  viewingGallery: boolean;
  proShop: boolean;
  stringingService?: boolean;
}

const initialCourts: SquashCourt[] = [
  {
    id: 1,
    name: "Championship Squash Center",
    price: "$45",
    duration: "per hour",
    rating: 4.9,
    reviews: 245,
    address: "123 Squash Avenue, Sports District, City 10001",
    availability: "Tomorrow, 3:00 PM",
    distance: "2.5 miles",
    host: {
      id: "host1",
      name: "Squash Authority",
      avatar: "SA",
      verified: true,
    },
    features: ["Glass Back Court", "Air Conditioned", "Ball Machines", "Pro Shop", "Video Analysis"],
    popular: true,
    new: true,
    category: "premium",
    instantBook: true,
    ...
    courtCount: 8,
    courtMaterial: "Timber",
    airConditioned: true,
    equipmentRental: true,
    professionalCoach: true,
    courtCondition: "Excellent",
    changingRooms: true,
    scoreboard: true,
    ballMachine: true,
    parking: true,
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: 189,
    address: "456 Court Road, Uptown, City 10002",
    ...
    features: ["Glass Back Court", "Air Conditioned", "Equipment Shop", "Cafe", "Showers"],
    trending: true,
    category: "premium",
    instantBook: true,
    courtType: "Glass Back",
    courtCount: 6,
    courtMaterial: "Plastic",
    airConditioned: true,
    equipmentRental: true,
    professionalCoach: true,
    courtCondition: "Excellent",
  ...
  },
  {
    ...
    features: ["Traditional Court", "Basic Facilities", "Parking", "Changing Rooms"],
    category: "community",
    courtType: "Traditional",
    courtCount: 4,
    courtMaterial: "Concrete",
  ...
  },
  {
    ...
    rating: 4.9,
    reviews: 134,
    address: "101 Glass Court Street, Elite Zone, City 10004",
    availability: "Saturday, 10:00 AM",
    distance: "1.2 miles",
    host: {
      id: "host4",
      name: "Pro Squash Group",
      avatar: "PSG",
      verified: true,
    },
    features: ["Championship Court", "Video Analysis", "Player Lounge", "Fitness Area"],
    new: true,
    trending: true,
    category: "premium",
    instantBook: true,
  ...
  },
  {
    ...
    features: ["Late Night Play", "Music System", "Food Court", "Ball Machines"],
    popular: true,
    category: "premium",
    instantBook: true,
    courtType: "Glass Back",
  ...
  },
  {
    ...
    features: ["Practice Courts", "Coaching", "Equipment Shop", "Video Analysis"],
    category: "practice",
    courtType: "Traditional",
    courtCount: 8,
    courtMaterial: "Multipurpose",
    airConditioned: false,
    equipmentRental: true,
    professionalCoach: true,
    courtCondition: "Fair",
...
const COURT_TYPES = [
  { label: "Glass Back", value: "glass", icon: Box },
  { label: "Traditional", value: "traditional", icon: SquareIcon },
  { label: "Championship", value: "championship", icon: Trophy },
];

const AMENITIES = [
  { label: "Air Conditioned", icon: Thermometer },
  ...
  { label: "Viewing Gallery", icon: Eye },
  { label: "Fitness Area", icon: Activity },
];
...
const SORT_OPTIONS = [
  ...
  { label: "Court Quality", value: "court_quality", icon: Award },
];
...
const CourtCard = ({ 
  ...
  const getCourtColor = (type: string) => {
    switch (type) {
      case "Glass Back": return "bg-gradient-to-r from-[#097E52] to-[#23B33A]";
      case "Championship": return "bg-gradient-to-r from-[#FFB800] to-[#FF9900]";
      case "Traditional": return "bg-gradient-to-r from-[#006177] to-[#269089]";
      default: return "bg-gradient-to-r from-gray-500 to-gray-700";
    }
  };

  const getCourtConditionColor = (condition: string) => {
    switch (condition) {
  ...
  const getLightingColor = (lighting: string) => {
    switch (lighting) {
      case "Professional": return "text-[#097E52] bg-[#097E52]/10";
            ...
            <div className="relative h-full w-full bg-gradient-to-br from-[#097E52]/5 to-[#23B33A]/5">
              ...
              <div className="absolute bottom-4 right-4 z-10">
                <div className="flex flex-col sm:flex-row gap-2">
                  ...
                  <div className={`${getCourtConditionColor(court.courtCondition)} text-xs font-medium px-3 py-1.5 rounded-full`}>
          ...
          <div className="flex-1 p-4 sm:p-6">
            <div className="h-full flex flex-col">
              ...
              <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 mb-4 sm:mb-5">
                <div className="flex-1">
                  <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 mb-3">
                    ...
                    {/* Court Condition Badge */}
                    <div className="hidden sm:block">
                      <div className={`px-3 py-1.5 ${getCourtConditionColor(court.courtCondition)} rounded-full text-sm font-medium`}>
                        {court.courtCondition} Condition
                      </div>
                    </div>
                  </div>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-4 sm:mb-6">
                ...
                <div className="bg-[#097E52]/5 rounded-lg sm:rounded-xl p-3 border border-[#097E52]/10">
                  <div className="flex items-center gap-2 mb-1">
                    <Thermometer className="h-4 w-4 text-[#097E52]" />
                    <span className="text-sm font-medium text-foreground">Air Conditioned</span>
                  </div>
                  <p className="text-xl font-bold text-foreground">{court.airConditioned ? "Yes" : "No"}</p>
                </div>
                <div className="bg-[#097E52]/5 rounded-lg sm:rounded-xl p-3 border border-[#097E52]/10">
                  <div className="flex items-center gap-2 mb-1">
                  ...
                  <p className="text-xl font-bold text-foreground">{court.lighting}</p>
                </div>
                <div className="bg-[#097E52]/5 rounded-lg sm:rounded-xl p-3 border border-[#097E52]/10">
                  <div className="flex items-center gap-2 mb-1">
                  ...
                  <p className="text-xl font-bold text-foreground">{court.professionalCoach ? "Available" : "No"}</p>
                </div>
              </div>
        ...
        <div className="p-4 sm:p-5">
          ...
          <div className="grid grid-cols-2 gap-2 sm:gap-3 mb-3 sm:mb-4">
            ...
            <div className="flex items-center gap-2">
              <Thermometer className="h-4 w-4 text-[#097E52]" />
              <span className="text-sm font-medium text-foreground">
                {court.airConditioned ? 'A/C' : 'No A/C'}
              </span>
            </div>
            <div className="flex items-center gap-2">
              <Lightbulb className="h-4 w-4 text-[#097E52]" />
            ...
            <div className={`px-2 py-1 rounded-full text-xs font-medium ${getCourtConditionColor(court.courtCondition)}`}>
              {court.courtCondition}
            </div>
          </div>
    ...
    <div className="h-full flex flex-col">
      ...
      <div className="p-4 sm:p-6 border-b border-gray-200">
        <div className="flex items-center justify-between mb-2">
          <div className="flex items-center gap-3">
            <Box className="h-6 w-6 text-[#097E52]" />
        ...
        <p className="text-gray-500 text-sm">Refine your squash courts search</p>
      </div>
  ...
  const filteredCourts = useMemo(() => {
    ...
    if (searchQuery) {
      ...
      result = result.filter(court =>
        ...
        court.courtMaterial.toLowerCase().includes(query)
      );
    }
    ...
    if (selectedAmenities.length > 0) {
      result = result.filter(court =>
        selectedAmenities.every(amenity => {
          if (amenity === "Air Conditioned") return court.airConditioned;
          ...
          if (amenity === "Video Analysis") return court.features.includes("Video Analysis");
          if (amenity === "Equipment Rental") return court.equipmentRental;
          if (amenity === "Parking") return court.parking;
          if (amenity === "Viewing Gallery") return court.viewingGallery;
    ...
    if (selectedAvailability !== "any") {
      result = result.filter(court => {
        ...
        if (selectedAvailability === "night") {
          ...
          return time.includes("pm") && (time.includes("8:") || time.includes("9:") || time.includes("10:"));
        }
        const time = court.availability.toLowerCase();
        ...
        if (selectedAvailability === "evening") {
          return time.includes("pm") && 
                 (time.includes("6:") || time.includes("7:") || time.includes("8:"));
        }
        return true;
      });
    }
    ...
    switch (sortBy) {
      ...
      case "court_quality":
        ...
        result.sort((a, b) => qualityOrder[b.courtCondition] - qualityOrder[a.courtCondition]);
        break;
      default:
        result.sort((a, b) => {
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 py-4">
            <div className="flex items-center justify-between gap-4">
              <div className="flex items-center gap-3 sm:gap-4">
                ...
                <div>
                  <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-foreground">Squash Courts</h1>
                  <p className="text-gray-600 text-xs sm:text-sm mt-1">
                    Book professional squash courts & facilities
                  </p>
                </div>
              </div>
            ...
            <div className="flex-1 max-w-2xl">
              <div className="relative group">
                ...
                <input
                  type="text"
                  placeholder="Search squash courts, glass back courts, or locations..."
                  value={searchQuery}
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 mb-3">
                    <div>
                      <h2 className="text-lg sm:text-xl font-bold text-foreground">
                        {filteredCourts.length} {filteredCourts.length === 1 ? 'Squash Court' : 'Squash Courts'} Available
                      </h2>
                      {activeFilterCount > 0 && (
                        <p className="text-gray-600 text-xs sm:text-sm mt-1">
                    ...
                    {activeFilterCount > 0 && (
                      <div className="flex flex-wrap gap-2">
                        ...
                        {selectedCourtType.length > 0 && (
                          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-[#097E52]/10 to-[#23B33A]/10 rounded-full px-2.5 sm:px-3 py-1.5 sm:py-2">
                            <Box className="h-3 sm:h-3.5 w-3 sm:w-3.5 text-[#097E52]" />
                            <span className="text-xs sm:text-sm font-medium text-[#097E52]">
                              {selectedCourtType.length} court type{selectedCourtType.length > 1 ? 's' : ''}
                            </span>
                            <button
                              onClick={() => setSelectedCourtType([])}
                              className="text-[#097E52]/60 hover:text-[#097E52] p-0.5 rounded-full hover:bg-[#097E52]/10 transition-colors ml-1"
            ...
            {filteredCourts.length === 0 ? (
              <div className="text-center py-12 sm:py-16 bg-white rounded-xl sm:rounded-2xl border border-gray-200 shadow-sm">
                <div className="w-16 h-16 sm:w-24 sm:h-24 mx-auto mb-4 sm:mb-6 rounded-full bg-gradient-to-r from-gray-50 to-gray-100 flex items-center justify-center">
                  <Box className="h-8 w-8 sm:h-12 sm:w-12 text-gray-400" />
                </div>
                <h3 className="text-xl sm:text-2xl font-bold text-foreground mb-2 sm:mb-3">No squash courts found</h3>
                <p className="text-gray-600 mb-6 sm:mb-8 max-w-md mx-auto px-4 text-sm sm:text-base">
                  Try adjusting your search criteria or explore different court types
                </p>
...
export default SquashCourtsPage;