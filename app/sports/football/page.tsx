...
import { 
  ...
  Music,
  Goal,
  FireExtinguisherIcon as Soccer,
  Shirt,
  LucideFishOff as Whistle,
  Medal,
  Footprints,
  LucideIcon
} from "lucide-react";
...
interface FootballVenue {
  ...
  pitchType: "Natural Grass" | "Artificial Turf" | "Hybrid" | "Synthetic";
  pitchCount: number;
  pitchSize: "5-a-side" | "7-a-side" | "11-a-side" | "Full Size";
  floodLights: boolean;
  ...
  lockerRooms: boolean;
  firstAid: boolean;
  trainingEquipment: boolean;
}

const initialVenues: FootballVenue[] = [
  {
    id: 1,
    ...
    rating: 4.9,
    reviews: 287,
    address: "123 Stadium Road, Downtown, City 10001",
    ...
    features: ["Natural Grass", "Flood Lights", "Professional Coach", "Bleachers", "Pro Shop"],
    popular: true,
    new: true,
    category: "premium",
    instantBook: true,
  ...
  {
    id: 2,
    name: "City Football Center",
    price: "$95",
    duration: "per hour",
    rating: 4.8,
    reviews: 192,
    address: "456 Sports Lane, Uptown, City 10002",
    ...
    features: ["Artificial Turf", "Flood Lights", "Equipment Rental", "Cafe", "Showers"],
    trending: true,
    category: "premium",
    instantBook: true,
  ...
  },
  {
    ...
    rating: 4.6,
    reviews: 134,
    address: "789 Park Avenue, Suburbs, City 10003",
    availability: "Saturday, 3:00 PM",
    distance: "3.5 miles",
    host: {
      id: "host3",
    ...
    features: ["Synthetic", "Basic Facilities", "Parking", "Changing Rooms"],
    category: "community",
    pitchType: "Synthetic",
    pitchCount: 1,
    pitchSize: "7-a-side",
  ...
  },
  {
    ...
    rating: 4.7,
    reviews: 156,
    address: "101 Indoor Street, Sports District, City 10004",
    availability: "Sunday, 8:00 AM",
    distance: "0.8 miles",
    host: {
      id: "host4",
      name: "Futsal Professionals",
      avatar: "FP",
      verified: true,
    },
    features: ["Indoor Court", "AC", "Music System", "Video Analysis"],
    new: true,
    trending: true,
    category: "indoor",
    instantBook: true,
  ...
  {
    id: 5,
    name: "Night Football Stadium",
    price: "$120",
    duration: "per hour",
    rating: 4.9,
    reviews: 178,
    address: "202 Night Boulevard, Entertainment Zone, City 10005",
    availability: "Friday, 9:00 PM",
    distance: "2.8 miles",
    host: {
      id: "host5",
      name: "Night Sports Entertainment",
      avatar: "NSE",
      verified: true,
    },
    features: ["Floodlit Pitch", "Music System", "Food Court", "VIP Lounge"],
    popular: true,
    category: "premium",
    instantBook: true,
    pitchType: "Hybrid",
  ...
  {
    id: 6,
    name: "Training Football Center",
    price: "$45",
    duration: "per hour",
    rating: 4.5,
    reviews: 89,
    address: "303 Training Lane, Industrial Area, City 10006",
    availability: "Monday, 6:00 AM",
    distance: "1.0 miles",
    host: {
      id: "host6",
    ...
    features: ["Training Equipment", "Coaching", "Video Analysis", "Gym Access"],
    category: "training",
    pitchType: "Artificial Turf",
    pitchCount: 6,
    pitchSize: "5-a-side",
...
const CATEGORIES = [
  ...
  { label: "Premium", value: "premium", count: 3 },
  { label: "Community", value: "community", count: 1 },
  { label: "Indoor", value: "indoor", count: 1 },
  { label: "Training", value: "training", count: 1 },
];

const PITCH_TYPES = [
  { label: "Natural Grass", value: "natural", icon: Sprout },
  { label: "Artificial Turf", value: "artificial", icon: Square },
  { label: "Hybrid", value: "hybrid", icon: Droplet },
  { label: "Synthetic", value: "synthetic", icon: Thermometer },
];
...
const AMENITIES = [
  ...
  { label: "Equipment Rental", icon: Soccer },
  { label: "Professional Coach", icon: Whistle },
  { label: "Showers", icon: Waves },
  { label: "Bleachers", icon: Users },
  { label: "Scoreboard", icon: Trophy },
  { label: "Parking", icon: Car },
  { label: "Pro Shop", icon: ShoppingBag },
  { label: "Cafe", icon: Coffee },
  { label: "Lockers", icon: Lock },
  { label: "First Aid", icon: Shield },
  { label: "Training Equipment", icon: Dumbbell },
];
...
const SORT_OPTIONS = [
  ...
  { label: "Pitch Size", value: "pitch_size", icon: Goal },
];
...
const VenueCard = ({ 
  ...
  const handleCardClick = () => {
    router.push(`/football-detail/${venue.id}`);
  };
  ...
  const getPitchColor = (type: string) => {
    switch (type) {
      case "Natural Grass": return "bg-gradient-to-r from-[#097E52] to-[#23B33A]";
      case "Artificial Turf": return "bg-gradient-to-r from-[#006177] to-[#269089]";
      case "Hybrid": return "bg-gradient-to-r from-[#7ABC82] to-[#097E52]";
      case "Synthetic": return "bg-gradient-to-r from-[#FFB800] to-[#FF9900]";
      default: return "bg-gradient-to-r from-gray-500 to-gray-700";
    }
  };

  const getPitchSizeColor = (size: string) => {
    switch (size) {
      case "Full Size": return "text-[#097E52] bg-[#097E52]/10";
      case "11-a-side": return "text-[#006177] bg-[#006177]/10";
      case "7-a-side": return "text-[#FFB800] bg-[#FFB800]/10";
      case "5-a-side": return "text-[#7ABC82] bg-[#7ABC82]/10";
            ...
            <div className="relative h-full w-full bg-gradient-to-br from-[#097E52]/5 to-[#23B33A]/5">
              ...
              <div className="absolute bottom-4 right-4 z-10">
                <div className="flex flex-col sm:flex-row gap-2">
                  ...
                  <div className={`${getPitchSizeColor(venue.pitchSize)} text-xs font-medium px-3 py-1.5 rounded-full`}>
                    {venue.pitchSize}
                  </div>
                </div>
              </div>
                ...
                <div className="flex-1">
                  <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 mb-3">
                    ...
                    <div className="hidden sm:block">
                      <div className={`px-3 py-1.5 ${getPitchSizeColor(venue.pitchSize)} rounded-full text-sm font-medium`}>
                        {venue.pitchSize}
                      </div>
                    </div>
                  </div>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-4 sm:mb-6">
                <div className="bg-[#097E52]/5 rounded-lg sm:rounded-xl p-3 border border-[#097E52]/10">
                  <div className="flex items-center gap-2 mb-1">
                    <Soccer className="h-4 w-4 text-[#097E52]" />
                ...
                <div className="bg-[#097E52]/5 rounded-lg sm:rounded-xl p-3 border border-[#097E52]/10">
                  <div className="flex items-center gap-2 mb-1">
                    <Goal className="h-4 w-4 text-[#097E52]" />
                    <span className="text-sm font-medium text-foreground">Pitch Size</span>
                  </div>
                  <p className="text-xl font-bold text-foreground">{venue.pitchSize}</p>
                </div>
                <div className="bg-[#097E52]/5 rounded-lg sm:rounded-xl p-3 border border-[#097E52]/10">
                  <div className="flex items-center gap-2 mb-1">
                ...
                <div className="bg-[#097E52]/5 rounded-lg sm:rounded-xl p-3 border border-[#097E52]/10">
                  <div className="flex items-center gap-2 mb-1">
                    <Whistle className="h-4 w-4 text-[#097E52]" />
      ...
      ">
        ...
        <div className="p-4 sm:p-5">
          ...
          <div className="grid grid-cols-2 gap-2 sm:gap-3 mb-3 sm:mb-4">
            ...
            <div className={`px-2 py-1 rounded-full text-xs font-medium ${getPitchSizeColor(venue.pitchSize)}`}>
              {venue.pitchSize}
            </div>
          </div>
...
const FilterSidebar = ({
  ...
  setSelectedPitchSize: (sizes: string[]) => void;
    ...
    <div className="h-full flex flex-col">
      ...
      <div className="p-4 sm:p-6 border-b border-gray-200">
        <div className="flex items-center justify-between mb-2">
          <div className="flex items-center gap-3">
            <Soccer className="h-6 w-6 text-[#097E52]" />
        ...
        <p className="text-gray-500 text-sm">Find your perfect football pitch</p>
      </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-2">
            {PITCH_SIZES.map((size) => (
              <button
                key={size.value}
                onClick={() => setSelectedPitchSize(
                  selectedPitchSize.includes(size.value)
                    ? selectedPitchSize.filter(s => s !== size.value)
                    : [...selectedPitchSize, size.value]
                )}
                className={`
                  px-3 py-2.5 sm:py-3 rounded-lg sm:rounded-xl text-sm font-medium transition-all duration-200
                  text-center
        ...
        <div>
          ...
          <div className="space-y-2">
            {AVAILABILITY_OPTIONS.map((option) => {
              ...
              if (option.value === "weekends") Icon = Calendar;
...
const FootballGroundsPage = () => {
  ...
  const [selectedPitchSize, setSelectedPitchSize] = useState<string[]>([]);
  ...
  const filteredVenues = useMemo(() => {
    ...
    if (searchQuery) {
      ...
      result = result.filter(venue =>
        ...
        venue.pitchSize.toLowerCase().includes(query)
      );
    }
    ...
    if (selectedPitchType.length > 0) {
      result = result.filter(venue =>
        selectedPitchType.includes(venue.pitchType.split(' ')[0].toLowerCase())
      );
    }

    // Apply pitch size filter
    if (selectedPitchSize.length > 0) {
      result = result.filter(venue =>
        selectedPitchSize.includes(venue.pitchSize.toLowerCase())
      );
    }
    ...
    if (selectedAmenities.length > 0) {
      result = result.filter(venue =>
        selectedAmenities.every(amenity => {
          ...
          if (amenity === "Showers") return venue.showers;
          if (amenity === "Bleachers") return venue.bleachers;
          if (amenity === "Equipment Rental") return venue.equipmentRental;
          if (amenity === "Parking") return venue.parking;
          if (amenity === "Pro Shop") return venue.proShop;
          if (amenity === "Cafe") return venue.cafe;
          if (amenity === "First Aid") return venue.firstAid;
          if (amenity === "Training Equipment") return venue.trainingEquipment;
    ...
    if (selectedAvailability !== "any") {
      result = result.filter(venue => {
        ...
        if (selectedAvailability === "weekends") {
          return venue.availability.includes("Saturday") || venue.availability.includes("Sunday");
        }
    ...
    switch (sortBy) {
      ...
      case "distance_asc":
        ...
        break;
      case "pitch_size":
        const sizeOrder = { "Full Size": 4, "11-a-side": 3, "7-a-side": 2, "5-a-side": 1 };
        result.sort((a, b) => sizeOrder[b.pitchSize] - sizeOrder[a.pitchSize]);
        break;
      default:
        result.sort((a, b) => {
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 py-4">
            <div className="flex items-center justify-between gap-4">
              <div className="flex items-center gap-3 sm:gap-4">
                ...
                <div>
                  <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-foreground">Football Pitches</h1>
                  <p className="text-gray-600 text-xs sm:text-sm mt-1">
                    Book professional football pitches & stadiums
                  </p>
                </div>
              </div>
            ...
            <div className="flex-1 max-w-2xl">
              <div className="relative group">
                ...
                <input
                  type="text"
                  placeholder="Search football pitches, pitch types, or locations..."
                  value={searchQuery}
            ...
            <aside className="hidden lg:block w-80 flex-shrink-0 transition-all duration-300">
              <div className="sticky top-24">
                <FilterSidebar
                  ...
                  selectedPitchSize={selectedPitchSize}
                  setSelectedPitchSize={setSelectedPitchSize}
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 mb-3">
                    <div>
                      <h2 className="text-lg sm:text-xl font-bold text-foreground">
                        {filteredVenues.length} {filteredVenues.length === 1 ? 'Football Pitch' : 'Football Pitches'} Available
                      </h2>
                      {activeFilterCount > 0 && (
                        <p className="text-gray-600 text-xs sm:text-sm mt-1">
            ...
            {filteredVenues.length === 0 ? (
              <div className="text-center py-12 sm:py-16 bg-white rounded-xl sm:rounded-2xl border border-gray-200 shadow-sm">
                <div className="w-16 h-16 sm:w-24 sm:h-24 mx-auto mb-4 sm:mb-6 rounded-full bg-gradient-to-r from-gray-50 to-gray-100 flex items-center justify-center">
                  <Soccer className="h-8 w-8 sm:h-12 sm:w-12 text-gray-400" />
                </div>
                <h3 className="text-xl sm:text-2xl font-bold text-foreground mb-2 sm:mb-3">No football pitches found</h3>
...
export default FootballGroundsPage;